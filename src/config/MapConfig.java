...
public class MapConfig {
    ...
    public void configMap(int nbMap){
        if(nbMap == 0){
            configMap(nbMap, new Pair<>(10, 6), Sprite.DOWN);
        }
        if(nbMap == 1){
    ...
    private static class MapSetup{
        ...
        private static void setupMap0(){
            ...
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.DOWN, new Pair<>(i, 2)));
            ...
            for (int i = 14; i <= 14; ++i) m.add(addBlockingCell(Sprite.DOWN, new Pair<>(i, 5)));
            for (int i = 15; i <= 21; ++i) m.add(addCell(Sprite.GRASS, new Pair<>(i, 5)));
            for (int i = 22; i <= 22; ++i) m.add(addCell(Sprite.LEFT, new Pair<>(i, 5)));
            ...
            for (int i = 26; i <= 26; ++i) m.add(addCell(Sprite.GRASS, new Pair<>(i, 7)));
            for (int i = 27; i <= 27; ++i) m.add(addBlockingCell(Sprite.BUSH, new Pair<>(i, 7)));
            for (int i = 28; i <= 30; ++i) m.add(addCell(Sprite.GRASS, new Pair<>(i, 7)));
            ...
            for (int i = 24; i <= 25; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 8)));
            for (int i = 26; i <= 29; ++i) m.add(addCell(Sprite.GRASS, new Pair<>(i, 8)));
