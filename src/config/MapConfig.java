...
public class MapConfig {
    ...
    private static class MapSetup{
        ...
        private static void setupMap2(){
            ...
            for (int i = 17; i <= 24; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 0)));
            ...
            /*LIGNE 4*/
            for (int i = 0; i <= 4; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 3)));
            for (int i = 5; i <= 5; ++i) m.add(addBlockingCell(Sprite.TREE_DOWN_LEFT, new Pair<>(i, 3)));
            ...
            for (int i = 21; i <= 21; ++i) m.add(addBlockingCell(Sprite.TREE_DOWN_RIGHT, new Pair<>(i, 3)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 3)));
            for (int i = 23; i <= 23; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 3)));
            for (int i = 24; i <= 27; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 3)));
            for (int i = 28; i <= 28; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 3)));
            for (int i = 29; i <= 29; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT_RIGHT, new Pair<>(i, 3)));
            for (int i = 30; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 3)));
            /*LIGNE 5*/
            for (int i = 0; i <= 3; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 4)));
            for (int i = 4; i <= 4; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 4)));
            ...
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 4)));
            for (int i = 23; i <= 23; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 4)));
            for (int i = 24; i <= 27; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 4)));
            for (int i = 28; i <= 28; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 4)));
            for (int i = 29; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 4)));
            /*LIGNE 6*/
            for (int i = 0; i <= 3; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 5)));
            for (int i = 4; i <= 4; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 5)));
            ...
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 5)));
            for (int i = 23; i <= 23; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 5)));
            for (int i = 24; i <= 25; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 5)));
            for (int i = 26; i <= 26; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 5)));
            for (int i = 27; i <= 27; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT_RIGHT, new Pair<>(i, 5)));
            for (int i = 28; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 5)));
            /*LIGNE 7*/
            for (int i = 0; i <= 3; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 6)));
            for (int i = 4; i <= 4; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 6)));
            ...
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 6)));
            for (int i = 23; i <= 23; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 6)));
            for (int i = 24; i <= 25; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 6)));
            for (int i = 26; i <= 26; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 6)));
            for (int i = 27; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 6)));
            /*LIGNE 8*/
            for (int i = 0; i <= 4; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 7)));
            for (int i = 5; i <= 5; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT, new Pair<>(i, 7)));
            ...
            for (int i = 21; i <= 21; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 7)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 7)));
            for (int i = 23; i <= 23; ++i) m.add(addBlockingCell(Sprite.TREE_DOWN_LEFT, new Pair<>(i, 7)));
            for (int i = 24; i <= 25; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 7)));
            for (int i = 26; i <= 26; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 7)));
            for (int i = 27; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 7)));
            /*LIGNE 9*/
            for (int i = 0; i <= 5; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 8)));
            for (int i = 6; i <= 6; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT, new Pair<>(i, 8)));
            ...
            for (int i = 20; i <= 20; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 8)));
            for (int i = 21; i <= 21; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 8)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 8)));
            for (int i = 23; i <= 25; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 8)));
            for (int i = 26; i <= 26; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 8)));
            for (int i = 27; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 8)));
            /*LIGNE 10*/
            for (int i = 0; i <= 6; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 9)));
            for (int i = 7; i <= 8; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT_RIGHT, new Pair<>(i, 9)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT, new Pair<>(i, 9)));
            for (int i = 10; i <= 16; ++i) m.add(addCell(Sprite.GRASS, new Pair<>(i, 9)));
            for (int i = 17; i <= 17; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 9)));
            for (int i = 18; i <= 19; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT_RIGHT, new Pair<>(i, 9)));
            for (int i = 20; i <= 21; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 9)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 9)));
            for (int i = 23; i <= 24; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 9)));
            for (int i = 25; i <= 25; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 9)));
            for (int i = 26; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 9)));
            /*LIGNE 11*/
            for (int i = 0; i <= 9; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 10)));
            for (int i = 10; i <= 10; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT, new Pair<>(i, 10)));
            for (int i = 11; i <= 15; ++i) m.add(addCell(Sprite.GRASS, new Pair<>(i, 10)));
            for (int i = 16; i <= 16; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 10)));
            for (int i = 17; i <= 21; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 10)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.TREE_DOWN_LEFT, new Pair<>(i, 10)));
            for (int i = 23; i <= 24; ++i) m.add(addBlockingCell(Sprite.WATER, new Pair<>(i, 10)));
            for (int i = 25; i <= 25; ++i) m.add(addBlockingCell(Sprite.TREE_RIGHT_UP_DOWN, new Pair<>(i, 10)));
            for (int i = 26; i <= 31; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 10)));
            /*LIGNE 12*/
            for (int i = 0; i <= 10; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 11)));
            for (int i = 11; i <= 11; ++i) m.add(addBlockingCell(Sprite.TREE_UP_LEFT, new Pair<>(i, 11)));
            for (int i = 12; i <= 14; ++i) m.add(addTransitionCell(Sprite.GRASS, new Pair<>(i, 11), Direction.DOWN));
            for (int i = 15; i <= 15; ++i) m.add(addBlockingCell(Sprite.TREE_UP_RIGHT, new Pair<>(i, 11)));
            for (int i = 16; i <= 20; ++i) m.add(addBlockingCell(Sprite.TREE, new Pair<>(i, 11)));
            for (int i = 21; i <= 21; ++i) m.add(addBlockingCell(Sprite.TREE_LEFT_UP_DOWN, new Pair<>(i, 11)));
