...
public class MapConfig {
    ...
    private static class MapSetup{
        ...
        private static void setupMap8() {
            ...
            for (int i = 0; i <= 31; ++i) for (int j = 0; j <= 11; ++j) m.add(addCell(Sprite.SPACE_0, new Pair<>(i, j)));

            for (int i = 31; i <= 31; ++i) m.add(addTransitionCell(Sprite.SPACE_0, new Pair<>(i, 5), Direction.RIGHT));
            for (int i = 31; i <= 31; ++i) m.add(addTransitionCell(Sprite.SPACE_0, new Pair<>(i, 6), Direction.RIGHT));
            ...
            for (int i = 0; i <= 1; ++i) m.add(addBlockingCell(Sprite.TREE3, new Pair<>(i, 4)));
            ...
            for (int i = 0; i <= 1; ++i) m.add(addBlockingCell(Sprite.TREE3, new Pair<>(i, 7)));
            ...
            for (int i = 5; i <= 7; ++i) m.add(addBlockingCell(Sprite.ROCK2, new Pair<>(i, 4)));
            ...
            for (int i = 5; i <= 7; ++i) m.add(addBlockingCell(Sprite.ROCK2, new Pair<>(i, 7)));
            ...
            for (int i = 14; i <= 14; ++i) m.add(addBlockingCell(Sprite.PNJ12_DOWN, new Pair<>(i, 3), Interaction.SNAKE));
            for (int i = 18; i <= 18; ++i) m.add(addBlockingCell(Sprite.PNJ12_DOWN, new Pair<>(i, 4), Interaction.SNAKE));
            for (int i = 19; i <= 19; ++i) m.add(addBlockingCell(Sprite.PNJ12_DOWN, new Pair<>(i, 7), Interaction.SNAKE));
            for (int i = 12; i <= 12; ++i) m.add(addBlockingCell(Sprite.PNJ12_DOWN, new Pair<>(i, 8), Interaction.SNAKE));

            for (int i = 4; i <= 4; ++i) m.add(addBlockingCell(Sprite.PNJ1_RIGHT, new Pair<>(i, 5), Interaction.PNJ12));
            for (int i = 4; i <= 4; ++i) m.add(addBlockingCell(Sprite.PNJ1_RIGHT, new Pair<>(i, 6), Interaction.PNJ12));

            createBuilding(m, "HOUSE2_", 2, 2, new Pair<>(12, 2), null);
            createBuilding(m, "HOUSE2_", 2, 2, new Pair<>(19, 2), null);
            createBuilding(m, "HOUSE2_", 2, 2, new Pair<>(11, 6), null);
            createBuilding(m, "HOUSE2_", 2, 2, new Pair<>(20, 7), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(14, 1), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(17, 1), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(20, 1), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(23, 1), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(26, 1), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(14, 4), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(17, 4), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(20, 4), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(23, 4), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(26, 4), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(14, 7), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(17, 7), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(20, 7), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(23, 7), null);
            createBuilding(m, "SPACE_", 3, 3, new Pair<>(26, 7), null);
        ...
        private static void setupMap9() {
            ...
            for (int i = 0; i <= 0; ++i) m.add(addTransitionCell(Sprite.SPACE_0, new Pair<>(i, 5), Direction.LEFT));
            for (int i = 0; i <= 0; ++i) m.add(addTransitionCell(Sprite.SPACE_0, new Pair<>(i, 6), Direction.LEFT));
        ...
        private static void setupMap10() {
            ...
            for (int i = 0; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 0)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 1)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 1)));
            for (int i = 15; i <= 16; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 1)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 1)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 1)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 2; i <= 2; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 4; i <= 5; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 7; i <= 7; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 11; i <= 13; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 15; i <= 16; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 18; i <= 20; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 24; i <= 24; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 26; i <= 27; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 29; i <= 29; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 2)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 3)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 3)));
            for (int i = 11; i <= 11; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 3)));
            for (int i = 20; i <= 20; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 3)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 3)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 3)));
            for (int i = 0; i <= 2; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 4; i <= 7; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 11; i <= 11; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 13; i <= 14; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 17; i <= 18; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 20; i <= 20; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 24; i <= 27; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 29; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 4)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 5)));
            for (int i = 13; i <= 13; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 5)));
            for (int i = 18; i <= 18; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 5)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 5)));
            for (int i = 0; i <= 2; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 4; i <= 7; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 11; i <= 11; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 13;  i <= 18; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 20; i <= 20; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 24; i <= 27; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 29; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 6)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 4; i <= 4; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 11; i <= 11; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 20; i <= 20; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 27; i <= 27; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 7)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 2; i <= 2; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 6; i <= 7; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 11; i <= 13; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 15; i <= 16; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 18; i <= 20; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 24; i <= 25; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 29; i <= 29; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 8)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 2; i <= 3; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 5; i <= 7; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 9; i <= 9; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 13; i <= 13; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 15; i <= 16; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 18; i <= 18; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 22; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 24; i <= 26; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 28; i <= 29; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 9)));
            for (int i = 0; i <= 0; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 10)));
            for (int i = 9; i <= 11; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 10)));
            for (int i = 15; i <= 16; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 10)));
            for (int i = 20; i <= 22; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 10)));
            for (int i = 31; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 10)));
            for (int i = 0; i <= 31; ++i) m.add(addBlockingCell(Sprite.SPACE_0, new Pair<>(i, 11)));
