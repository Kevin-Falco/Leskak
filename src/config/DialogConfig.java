...
public enum DialogConfig {
    ...
    PNJ10_QUEST_BEFORE("A CHANGER : Si tu me montres un panda jte la donne wallah"),
    PNJ10_QUEST_BETWEEN("A CHANGER : Met ton skin avec la touche " + Key.CHANGE_SKIN.getKeyCode().getName() + " et reviens me parler" ),
    PNJ10_QUEST_AFTER("A CHANGER : OH PUTAIN UN PANDA VIENS LA QUE JTE ... donne de la dynamite"),
