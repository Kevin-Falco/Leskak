...
public enum DialogConfig {
    ...
    PNJ3_2_BEFORE("A CHANGER : Reprend le colis"),
    PNJ3_2_AFTER("A CHANGER : Merci de l'avoir repris"),
    ...
    PNJ5_BEFORE("A CHANGER : Va chercher mon colis STP"),
    PNJ5_AFTER("A CHANGER : Merci FRR"),
