...
public enum DialogConfig {
    ...
    PNJ3_2_BEFORE("Récupère le colis"),
    ...
    PNJ5_BEFORE("Bienvenue étranger ! En effet, vous êtes bien sur la planète Hibliss, là où les pilotes peuvent aguerris perdent leurs vaisseaux !\n" +
            "Si tu cherches des réacteurs en bon état, n'hésite pas à t'aventurer sur cette planète qui est un vrai labyrinthe !\n" +
            "Par ailleurs mon ami, aurais-tu un livreur sur la planète Jansen. Il a mon colis et j'aimerais le récupérer au plus vite..."),
